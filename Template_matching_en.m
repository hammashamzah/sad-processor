...
%Template Matching
%
%PART1：Gray scaling&Binarization
%PART2：Matching process for SAD(Sum of Absolute Difference)
%PART3：Drawing matching point
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%Initialization
clear all;
%Matching Threshold：Regarded as being matched being matched if SAD is smaller than "thres"
thres=500;
...
%--------------------------------------------------------------------------
%PART2：Matching process for SAD
disp('Part2')
tic;
